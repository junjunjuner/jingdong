...
ITEM_PIPELINES = {
   'jd.pipelines.JdtestPipeline': 300,
    'jd.pipelines.CSVPipeline': 200
...
MONGO_DB = "DFB"  # 库名
MONGO_COLL = "dfb_jd"  # 文档(相当于关系型数据库的表名)
# LOG_FILE='jdtest_log_%s.txt' % (time.strftime('%Y-%m-%d %H:%M:%S', time.localtime()))
LOG_FILE='jddfb_log.txt'
