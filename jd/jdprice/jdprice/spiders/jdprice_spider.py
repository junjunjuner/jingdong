...
class jdspider(scrapy.Spider):
    ...
    num=1
    start_urls=[
        "https://list.jd.com/list.html?cat=737,738,747"         #取暖电器
        ...
        try:
            ...
            for price_json in price_jsons:
                try:
                    id=price_json['id']
                    item['ProductID']=id[2:]
                    item['PreferentialPrice'] = price_json['p']
                    item['price']= price_json['m']
                except:
                    item['PreferentialPrice']=None
                    item['price']=None            #商品价格
                yield item
        except:
